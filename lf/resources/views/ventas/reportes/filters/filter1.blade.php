...
<div class="col-12 col-sm-4 col-md-3 col-lg-2  pb-0">
    ...
    <div class="col-12  col-sm-4 col-md-3 col-lg-2 pb-0">
        <label>Familia:</label>
        <x-familia-stock-chooser id="FAMILIA-STOCK" value="" name="" style="width:100% !important;"  class="form-control form-control-sm" callback="filtrar()" ></x-familia-stock-chooser>
    <x-pretty-checkbox callback="filtrar()"  id="F_FAMILIA_STOCK" name=""  value="N" onValue="S"  offValue="N"  label=""></x-pretty-checkbox>
    </div>
...
<script>
    async function filtrar() {
        ...
        let familia_stock = $("#FAMILIA-STOCK").val(); 
        ...
        if($("#F_FAMILIA_STOCK").val() ==  "S")
        param.FAMILIA_STOCK=  familia_stock;
