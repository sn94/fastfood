function dibujarGraficoDeBarras(targetCanvas, dataSet, aditionalParams) {
  ...
  let BACKGROUNDS = ['rgba(255, 99, 132)', 'rgba(54, 162, 235)', 'rgba(255, 206, 86)', 'rgba(75, 192, 192)', 'rgba(153, 102, 255)'];
  let BORDERS = ['rgba(255, 99, 132, 1)', 'rgba(54, 162, 235, 1)', 'rgba(255, 206, 86, 1)', 'rgba(75, 192, 192, 1)', 'rgba(153, 102, 255, 1)'];
...
function dibujarGraficoTorta(targetCanvas, dataSet) {
  ...
  let labelY = dataSet.labelY;
  let title = dataSet.title;
  let generalLabel = dataSet.generalLabel; //Data
  ...
  const data = {
    ...
    datasets: [{
      label: generalLabel,
      data: datos,
      backgroundColor: ['rgba(255, 99, 132)', 'rgba(4, 250, 235)', 'rgba(255, 90, 86)', 'rgba(200, 192, 200)', 'rgba(140, 252, 205)']
    }]
  };
  const config = {
    type: 'pie',
