...
<input type="hidden" id="GRILL-URL" value="{{url('servicios')}}">
<input type="hidden" id="GRILL-URL-CUSTOM" value="{{url('servicios/buscar')}}">
...
<div class="container mt-1 col-12 col-md-6 fast-food-bg  ">
    <h3 class="fast-food-big-title">Ficha de Servicios</h3>
    ...
    <x-search-report-downloader placeholder="BUSCAR POR DESCRIPCION" callback="buscarServicios()" />
