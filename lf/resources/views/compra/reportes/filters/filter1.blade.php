...
<div class="col-12 col-sm-4 col-md-3 col-lg-2  pb-0">
    ...
    <div class="col-12 col-sm-4 col-md-3 col-lg-2 pb-0">
        ...
        <x-pretty-checkbox callback="filtrar()" id="F_PROVEEDOR" name=""  value="N" onValue="S"  offValue="N"  label=""></x-pretty-checkbox>
    </div>
    ...
    <div class="col-12  col-sm-4 col-md-3 col-lg-2  pb-0">
          ...
          <x-forma-pago-chooser callback="filtrar()" class="form-control form-control-sm" style="" name="" value="" id="FORMA_PAGO"></x-forma-pago-chooser>
