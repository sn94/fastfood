...
<h2 class="text-center mt-2" style="font-family: titlefont;">Proveedores</h2>



<a class="btn btn-lg btn-warning" href="<?= url("proveedores/create") ?>"> NUEVO</a>

<div id="loaderplace"></div>

<input id="search" type="text" placeholder="BUSCAR POR CÉDULA O RUC, O NOMBRE" oninput="buscar( this)">
