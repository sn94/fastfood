...
<div class="container-fluid bg-dark text-light col-12 col-lg-10">
...
<div id="loaderplace"></div>
    ...
    @if( $ESTADO == "PENDIENTE")
    @include("deposito.ficha_produccion.index.pendientes")
    @elseif(  $ESTADO == "DESPACHADO")
    @include("deposito.ficha_produccion.index.aprobados")
    @elseif(  $ESTADO == "LISTO")
    @include("deposito.ficha_produccion.index.listos")
    @endif
