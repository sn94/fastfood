...
<h2 class="text-center mt-2" style="font-family: titlefont;">Familia de productos</h2>



<a class="btn btn-lg btn-warning" href="<?= url("familia/create") ?>"> NUEVO</a>

<div id="loaderplace"></div>

<input  autocomplete="off" id="search" type="text" placeholder="BUSCAR POR DESCRIPCION DE FAMILIA" oninput="buscar( this)">
