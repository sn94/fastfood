...
<fieldset id="INSUMOS-PANEL">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-8  pr-0 mb-1">
                <div style="display: flex;  flex-direction: row;">


                    <label  >ITEM:</label>
                    <a  data-toggle="tooltip" title="Click aquí para buscar un ítem"     href="#" onclick="insumos_controller.buscarEnStock( 'AF')"><i class="fa fa-search"></i></a>
                    <input  style="width: 60px;font-weight: 600; color: black; " class="form-control ITEM-ID " type="text" disabled>

                    <input   class="form-control ITEM" style="width: 100% !important; height: 40px;" autocomplete="off" type="text"   disabled>

                </div>
            </div>

            <div class="col-12  col-md-4  pl-1 mb-1">
                <div style="display: flex;  flex-direction: row;">
                    <label  >CANT.: </label>
