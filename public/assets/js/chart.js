...
!function (t, e) {
  ...
  function re(t, e) {
    ...
    const n = i.listeners,
          o = n.indexOf(e);
    -1 !== o && n.splice(o, 1), n.length > 0 || (se.forEach(e => {
      delete t[e];
    }), delete t._chartjs);
  }
  ...
  class li extends qe {
    acquireContext(t, e) {
      ...
      return i && i.canvas === t ? (function (t, e) {
        ...
        if (Ze(n)) if ("" === t.style.height) t.height = t.width / (e || 2);else {
          const e = ye(t, "height");
          void 0 !== e && (t.height = e);
        }
      }(t, e), i) : null;
  ...
  class ji extends Oi {
    ...
    _computeGridLineItems(t) {
      ...
      if ("top" === a) m = p(e.bottom), v = e.bottom - h, w = m - g, S = p(t.top) + g, D = t.bottom;else if ("bottom" === a) m = p(e.top), S = t.top, D = p(t.bottom) - g, v = m + g, w = e.top + h;else if ("left" === a) m = p(e.right), y = e.right - h, M = m - g, k = p(t.left) + g, P = t.right;else if ("right" === a) m = p(e.left), k = t.left, P = p(t.right) - g, y = m + g, M = e.left + h;else if ("x" === i) {
    ...
    _computeLabelItems(t) {
      ...
      if ("top" === o) y = e.bottom - u, v = e._getXAxisLabelAlignment();else if ("bottom" === o) y = e.top + u, v = e._getXAxisLabelAlignment();else if ("left" === o) {
        ...
        if ("center" === o) y = (t.top + t.bottom) / 2 + u;else if (U(o)) {
        ...
        if ("center" === o) _ = (t.left + t.right) / 2 - u;else if (U(o)) {
          const t = Object.keys(o)[0],
                i = o[t];
  ...
  function rn(t) {
    ...
    for (o = 0; o < e; ++o) if (s = a, a = r, r = sn(t, o + 1), a) {
      if (r) {
        const t = r.x - a.x;
        i[o] = 0 !== t ? (r.y - a.y) / t : 0;
      }
  ...
  function cn(t, e, i, n) {
    let o, s, a, r;
    if (e.spanGaps && (t = t.filter(t => !t.skip)), "monotone" === e.cubicInterpolationMode) rn(t);else {
  ...
  class Yn {
    ...
    buildOrUpdateControllers() {
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (s.type && s.type !== a && (t._destroyDatasetMeta(n), s = t.getDatasetMeta(n)), s.type = a, s.indexAxis = o.indexAxis || Dn(a, t.options), s.order = o.order || 0, t._updateMetasetIndex(s, n), s.label = "" + o.label, s.visible = t.isDatasetVisible(n), s.controller) s.controller.updateIndex(n), s.controller.linkScales();else {
          ...
          case "min-max":
            h = function (t, e) {
              ...
              for (i = 0; i < t.length; ++i) {
                ...
                const x = 0 | o;
                if (x === a) s < h ? (h = s, r = i) : s > d && (d = s, l = i), u = (f * u + n.x) / ++f;else {
                  const e = i - 1;
    ...
    _draw() {
      ...
      t.legendItems.forEach((e, u) => {
        ...
        !function (t, e, i) {
          ...
          a.restore();
        }(h.x(P), D, e), P = s(k, P + x + p, t.right), function (t, e, i) {
