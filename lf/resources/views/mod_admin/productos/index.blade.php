...
<input type="hidden" id="GRILL-URL" value="{{url('productos')}}">
<input type="hidden" id="GRILL-URL-CUSTOM" value="{{url('productos/buscar')}}">
...
<h2 class="text-center mt-2" style="font-family: titlefont;">Productos</h2>



<a class="btn btn-lg btn-warning" href="<?= url("productos/create") ?>"> NUEVO</a>

<div id="loaderplace"></div>

<input id="search" type="text" placeholder="BUSCAR POR CÓDIGO DE BARRA O DESCRIPCION DE PRODUCTO" oninput="buscar( this)">
