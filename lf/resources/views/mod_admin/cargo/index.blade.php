...
<h2 class="text-center mt-2" style="font-family: titlefont;">Cargos</h2>



<a class="btn btn-lg btn-warning" href="<?= url("cargo/create") ?>"> NUEVO</a>

<div id="loaderplace"></div>

<input  autocomplete="off" id="search" type="text" placeholder="BUSCAR POR DESCRIPCION DE CARGO" oninput="buscar( this)">
