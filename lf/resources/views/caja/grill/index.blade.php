...
<table class="table fast-food-table bg-gradient    text-dark">
    ...
    <tbody>
        ...
        @foreach( $caja as $prov)
        <tr>
            <td>
                <a  onclick="edit_row(event)" style="color: black;" href="{{url('caja/update').'/'.$prov->REGNRO}}"> <i class="fas fa-edit"></i></a>
            </td>
            <td>
                <a onclick="delete_row(event)" style="color: black;" href="{{url('caja').'/'.$prov->REGNRO}}"> <i class="fa fa-trash"></i></a>
            </td>
...
{{ $caja->links('vendor.pagination.default') }}
