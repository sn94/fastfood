        ...
        <div class="row  ">
            ...
            <div class="col-12 col-md-8  pr-0 mb-1">
                <div style="display: flex;  flex-direction: row;">
                    ...
                    <label>ITEM:</label>
                    <a data-toggle="tooltip" title="Click aquí para buscar un ítem" style="grid-column-start: 2; " href="#" onclick="ingredientes_controller.buscarEnStock( 'MP')"><i class="fa fa-search"></i></a>
