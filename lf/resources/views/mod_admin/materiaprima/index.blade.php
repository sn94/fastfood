...
<input type="hidden" id="GRILL-URL" value="{{url('materia-prima')}}">
<input type="hidden" id="GRILL-URL-CUSTOM" value="{{url('materia-prima/buscar')}}">
...
<h2 class="text-center mt-2" style="font-family: titlefont;">Materia prima</h2>



<a class="btn btn-lg btn-warning" href="<?= url("materia-prima/create") ?>"> NUEVO</a>

<div id="loaderplace"></div>

<input  autocomplete="off" id="search" type="text" placeholder="BUSCAR POR CÓDIGO DE BARRA O DESCRIPCION DE PRODUCTO" oninput="buscar( this)">
