...
<form  onsubmit="pedir_recibir(event)" method="POST" action="{{url('compra/unitaria')}}">
    @csrf
    ...
    <span style="font-size: 18px;" class="badge badge-warning">{{ $pedido->stock->unidad_medida->DESCRIPCION}}</span>
